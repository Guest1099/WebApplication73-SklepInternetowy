    ...
    public class UserAccountService : IUserAccountService
    {
        ...
        public async Task<List<ApplicationUser>> GetAll()
        {
            return await _context.Users
                ...
                .OrderBy(o => o.DaneOsobowe.DataDodania)
                .ToListAsync();
        }
        ...
        public async Task<ApplicationUser> GetUserByDaneOsoboweId(string daneOsoboweId)
        {
            return await _context.Users
                .Include(i => i.DaneOsobowe)
                .FirstOrDefaultAsync(f => f.DaneOsobowe.DaneOsoboweId == daneOsoboweId);
        }
        ...
        public async Task<LoginViewModel> Login(LoginViewModel model)
        {
            if (!string.IsNullOrEmpty(model.Email))
            {
                ...
                if (user != null)
                {
                    bool zapamietajPoZalogowaniu = true;
                    var result = await _signInManager.PasswordSignInAsync(user, model.Password, false, zapamietajPoZalogowaniu);
                    if (result.Succeeded)
                    {
